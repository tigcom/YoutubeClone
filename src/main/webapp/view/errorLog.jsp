...
<head>
    ...
    <link rel="icon" href="https://img-cache.coccoc.com/image2?i=2&l=19/306881396" type="image/x-icon">
    <title>YouTube Fake - Cảnh Báo</title>
...
.text_4041 {
  transform: scaleY(24.5) scaleX(20);
}
.text_4042 {
  transform: scaleY(24.5) scaleX(20);
}
...
<div class="main_wrapper col-12 ">
      ...
      <div class="display_div">
        <div class="screen_out">
          <div class="screen_out1">
            <div class="screen">
              <span class="notfound_text py-2">${messss2}</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="text_404">
    <div class="text_4041 mx-3 fs-4">4</div>
    <div class="text_4042 mx-5 fs-4">0</div>
    <div class="text_4043 mx-3 fs-4">4</div>
  </div>
</div>
    
 
        <a href="${ctx}/index/video" id="homeA" class="btn-class-name">
